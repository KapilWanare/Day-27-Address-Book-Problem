...
public class AddressBookMain {
    ...
    private void writeToFile() {
        String path = "C:\\Java\\Day-27-Address-Book-Problem\\src\\address_book.txt";
    ...
    public static void main(String[] args) {
        ...
        while(true){
            ...
            System.out.println("11) press 11 to Display all the contact from the file ");
            System.out.println("12) press 12 to Write The Contact Details  In Text File ");
